...
#define CUSTOM_MACHINE_NAME "Kossel XL"
...
#define TEMP_SENSOR_0 1	//7
#define TEMP_SENSOR_1 0
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_BED 1	//11
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 315.0		//215.0 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 219.0	//145.0 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 30.0	//19.9 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 20.0	//19.5 // mm

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 95	//90
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0  //-10   // Z probe to nozzle Y offset: -front +behind
  ...
  #define XY_TRAVEL_SPEED 7200         // X and Y axis travel speed between probes, in mm/min.
...
//#define Z_PROBE_END_SCRIPT "G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10" // These commands will be executed in the end of G29 routine.
  #define Z_PROBE_END_SCRIPT "G1 X0 Y0 Z10 F9000" 							// These commands will be executed in the end of G29 routine.
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 315  //250 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 95.5}	//{160, 160, 160, 191}  //{80, 80, 80, 760*1.1} // default steps per unit for Kossel (GT2, 20 tooth)
